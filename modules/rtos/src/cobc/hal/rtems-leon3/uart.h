...
namespace cobc
{
	namespace leon3
	{
		...
		public:
			...
			/*! \fn UART(char * path, uint32_t baud)
			...
			/*! \fn std::size_t	read(uint8_t* data, std::size_t length, time::Duration timeout = time::Duration::infinity())
			...
			/*! \fn std::size_t write(const uint8_t* data, std::size_t length, time::Duration timeout = time::Duration::infinity())
