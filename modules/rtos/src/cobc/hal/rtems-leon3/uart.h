...
namespace cobc
{
    namespace leon3
    {
        ...
        public:
            ...
            enum States
            {
                OPEN = 0, CLOSE, ENABLED, DISABLED, READY, BUSY
            };
            ...
            /**
             * Check the device availability. Status field is updated
             * during every device operation stage. The availability
             * can be expressed as a READY state of the device
             *
