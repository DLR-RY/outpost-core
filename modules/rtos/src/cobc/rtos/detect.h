...
#ifndef RTOS_DETECT_H
#define RTOS_DETECT_H

/**
 * Possible values for \c COBC_RTOS.
 *
 * \addtogroup rtos
 */
///\{
...
#        error "'COBC_RTOS_RTEMS' defined but not '__rtems__'. Please check your toolchain!"
#    endif
...
#    if !defined(__unix__)
#        error "'COBC_RTOS_POSIX' defined but not '__unix__'. Please check your toolchain!"
#    endif
#else
