...
TEST(DateUnixTest, convertDatesToUnixTime)
{
...
TEST(DateUnixTest, convertDatesToUnixTimeForRandomDates)
{
...
TEST(DateUnixTest, convertDatesToUnixTimeForLeapYears)
{
...
TEST(DateUnixTest, convertDatesToUnixTimeDuringLeapSeconds)
{
...
TEST(DateUnixTest, convertUnixTimeToDate)
{
    // Calculated reference values from "http://www.andrews.edu/~tzs/timeconv/timeconvert.php"
    // test the beginning of GPS seconds (06.01.1980)
...
TEST(DateUnixTest, convertUnixTimeToDateForRandomTimes)
{
...
TEST(DateUnixTest, convertUnixTimeToDateForLeapYears)
{
...
TEST(DateUnixTest, convertUnixTimeToDateForLeapSeconds)
{
