...
size_t
SerialStub::read(outpost::Slice<uint8_t> data, outpost::time::Duration /*timeout*/)
{
...
size_t
SerialStub::write(outpost::Slice<const uint8_t> data, outpost::time::Duration /*timeout*/)
{
