...
#ifndef OUTPOST_UTILS_SERIALIZE_LITTLE_ENDIAN_IMPL_H
#define OUTPOST_UTILS_SERIALIZE_LITTLE_ENDIAN_IMPL_H
...
template <>
inline void
SerializeLittleEndian::store<outpost::BoundedArray<const uint8_t> >(outpost::BoundedArray<const uint8_t> array)
{
