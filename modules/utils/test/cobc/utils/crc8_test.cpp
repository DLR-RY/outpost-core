...
TEST(Crc8CcittReversedTest, rmapTestPattern1)
{
    ...
    EXPECT_EQ(0xB0U, Crc8CcittReversed::calculate(cobc::toArray(data)));
}
...
TEST(Crc8CcittReversedTest, rmapTestPattern2)
{
    ...
    EXPECT_EQ(0x84U, Crc8CcittReversed::calculate(cobc::toArray(data)));
}
...
TEST(Crc8CcittReversedTest, rmapTestPattern3)
{
    ...
    EXPECT_EQ(0x18U, Crc8CcittReversed::calculate(cobc::toArray(data)));
}
...
TEST(Crc8CcittReversedTest, rmapTestPattern3Total)
{
    ...
    EXPECT_EQ(0U, Crc8CcittReversed::calculate(cobc::toArray(data)));
}
...
TEST(Crc8CcittReversedTest, rmapCrcTestPattern1)
{
    ...
    EXPECT_EQ(0x9FU, Crc8CcittReversed::calculate(cobc::toArray(header)));
    EXPECT_EQ(0x56U, Crc8CcittReversed::calculate(cobc::toArray(data)));
}
...
TEST(Crc8CcittReversedTest, rmapCrcTestPatternCommand)
{
    ...
    EXPECT_EQ(0xF7U, Crc8CcittReversed::calculate(cobc::toArray(header)));
}
...
TEST(Crc8CcittReversedTest, rmapCrcTestPatternReply)
{
    ...
    EXPECT_EQ(0x52U, Crc8CcittReversed::calculate(cobc::toArray(header)));
    EXPECT_EQ(0xB4U, Crc8CcittReversed::calculate(cobc::toArray(data)));
}
...
TEST(Crc8CcittReversedTest, bitwiseTest)
{
    ...
    EXPECT_EQ(crc, Crc8CcittReversed::calculate(cobc::toArray(data)));
}
