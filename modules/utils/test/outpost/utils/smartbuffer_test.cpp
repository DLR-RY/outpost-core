...
public:
    ...
    void passByRef(outpost::utils::SmartBufferPointer& p);
    void passByValue(outpost::utils::SmartBufferPointer p);
};
...
void SmartBufferTest::passByRef(outpost::utils::SmartBufferPointer& p)
{
...
void SmartBufferTest::passByValue(outpost::utils::SmartBufferPointer p)
{
	EXPECT_EQ(p->getReferenceCount(), 4U);
